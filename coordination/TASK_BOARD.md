...
| BUG-001 | Resilient 404 handling in YouTube Adapter | senior-dev | in_review | P1-007 | Adapter catches 404/HTTP errors from feed fetching, logs a warning, and returns empty list instead of crashing. |
